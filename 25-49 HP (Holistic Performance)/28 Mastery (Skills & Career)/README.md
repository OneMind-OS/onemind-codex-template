---
id: hp-28-readme
title: "28 — Mastery (Skills & Career)"
type: index
status: active
created: 2026-01-01
owner: zeus
tags: [domain/hp-28, type/index, status/active]
ai_summary: "Mastery domain — professional skills, career trajectory, reputation, and expertise development"
---
...
└── mentors.md                    ← People actively shaping your growth
```
...
1. Write `career-overview.md` — where you are right now and where you want to go in 3 years
2. Build a `skill-map.md` — list 10–15 skills and rate your current level honestly
3. Identify your top 3 professional goals for this year
4. Write a 3-sentence bio for `reputation/public-presence.md` — how you'd introduce yourself professionally
